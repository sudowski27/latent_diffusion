...
class Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        output_1 = self.sigmoid(output_0)
        output_2 = self.layer_1(output_1)
        output_3 = self.sigmoid(output_2)
        output_4 = self.layer_2(output_3)
        output_5 = self.sigmoid(output_4)
        output_6 = self.layer_3(output_5)
        output_7 = self.sigmoid(output_6)
        output_8 = self.layer_4(output_7)
        output_9 = self.sigmoid(output_8)
        output_10 = self.layer_5(output_9)
        output_11 = self.sigmoid(output_10)
